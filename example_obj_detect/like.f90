...
!----------------------------------------------------------------------
      ...
      subroutine sCreateData(var,sdata,spredict)
         ...
         real*8 var(4),sdata(snpix,snpix),tmp
         logical spredict
         integer i,j,k
         real*8 gap!pixel gap in each direction between clusters
...
!=======================================================================
      ...
      subroutine slikelihood(Cube,slhood)
         ...
         real*8 Cube(sdim),slhood
         real*8 spdata(snpix,snpix),Chisq,temp(4)
         integer i,j
