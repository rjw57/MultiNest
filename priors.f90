...
function dierfc(y)
	...
	implicit none
      	real*8 y,dierfc
      	real*8 qa,qb,qc,qd,q0,q1,q2,q3,q4,pa,pb,p0,p1,p2,p3,p4,p5,p6,p7,p8,p9,p10,p11,p12,p13,p14,p15,p16,p17,p18
      	real*8 p19,p20,p21,p22,x,z,w,u,s,t
      	real*8 infinity
